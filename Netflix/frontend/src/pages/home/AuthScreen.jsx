...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
        ...
        <header className='max-w-6xl max-auto flex items-center justify-between p-4 pb-10'>
        ...
        <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
            ...
            <p className='text-lg md-4'>watch anywhere. Cancel anytime.</p>
            <p className='text-lg md-4'>Ready to watch? Enter your email to create or restart your membership.</p>
            ...
            <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
                ...
                <button className='bg-red-600 text-xl lg:text-2xl  lg:px-6 py-1 px-2 md:py-2 rounded flex justify-center items-center'>Get Started <ChevronRight className='size-8 md:size10'/> </button>
            </form>
        </div>
